...
# - Zusammenfuehren aller Versionen der interaktiven Grabenstroemung
...
# </figure>
# 
# **Frage 2:** Entscheiden Sie für die Randbedingungen **A, B, und C** (S. Abb. 2), ob es sich um physikalische oder hydraulische Randbedingungen handelt:

# In[5]:


display_quiz("/home/grabow/Dropbox/SHK/Jupyter/HydroTeaching/questions_boundary_types.json")
...
# * Welche Art von Randbedingung schlagen Sie für **B** (siehe Abb. 2) vor?

# In[6]:


display_quiz("/home/grabow/Dropbox/SHK/Jupyter/HydroTeaching/questions_grundwasserscheide.json")
